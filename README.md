...
즉, 아무런 계획없이 진행하지 않으며 그렇다고 지나친 계획으로 문서의 낭비, 스트레스, 비용을 낭비하지 않는 중간의 타협점을 찾아 2주 단위로 그때 그때의 요구사항을 수립하여 프로젝트의 버전을 점점 발전해가며 커다란 소프트웨어로 완성시키는 것. 

## Team
  - 김정현 (00125) : 총괄, 사운드, 스토리구성, 영상제작
